        ...
        {activeTab === 'dashboard' && (
          <>
            ...
            <section className="kpis">
              ...
              <Metric icon={<Target size={17} />} title="Meta de horas" value={formatDurationHours(summary.targetTotal)} hint="Planejado" tooltip="Total de horas planejadas no Admin para este período." />
